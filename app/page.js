...
function AdminShell({ user, onLogout, children, active, setActive }) {
  ...
  <img src="/ckc-wordmark-white.png" alt="C. Krishniah Chetty - Group of Jewellers" className="w-full max-w-[150px] h-auto" />
  <div className="text-[10px] text-amber-200/60 tracking-[0.2em] mt-1">
